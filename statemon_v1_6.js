...
/* Notes: */ {
    ...
    // ----
    // v1.01: vastly improved memory usage and garbage collection.
    // v1.02: added browser log output instead of console (toggle in options).
    //       output is faster with the browser & has less interference.
    // v1.04: made the browser output much prettier.
    // v1.05: (coming soon) todo: find the state without being given a div name
    // v1.06: added RAM overflow handling & better garbage collection.
}
